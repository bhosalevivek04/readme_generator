...
import { faCode, faMagicWandSparkles, faLightbulb, faRocket, faUsers } from '@fortawesome/free-solid-svg-icons';
    ...
    <div className="bg-gray-900 text-white min-h-screen">
      ...
      <nav className="bg-gray-800 p-4">
        <div className="container mx-auto flex justify-between items-center">
          <Link to="/" className="text-green-300 text-2xl font-bold">README Generator</Link>
        </div>
      </nav>
        ...
        <div className="flex flex-col items-center lg:flex-row lg:items-start">
          <div className="w-full lg:w-1/2 text-center lg:text-left lg:pr-8 mb-8 lg:mb-0">
            <h1 className="text-4xl lg:text-5xl font-bold mb-4">
              Create README <span className={`text-green-300 ${fade ? 'fade-in' : 'fade-out'}`}>{words[currentWord]}</span>
            </h1>
            <p className="text-xl mb-8">
              Generate beautiful and informative README files for your GitHub projects with ease. Trusted by developers, our tool ensures your documentation is professional and comprehensive. 
              This unique tool, developed as a helpful project, leverages cutting-edge technology to provide intelligent suggestions and seamless GitHub integration, making it an indispensable asset for developers looking to enhance their project documentation.
            </p>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              { icon: faLightbulb, title: 'Intelligent Suggestions', description: 'Get smart suggestions to enhance your README content' },
      ...
      <section className="container mx-auto py-20 px-4">
        <div className="flex flex-col items-center lg:flex-row lg:items-start">
          ...
          <div className="w-full lg:w-2/3 text-center lg:text-left px-4 lg:px-0">
            ...
            <a href="https://github.com/bhosalevivek04/readme_generator" target="_blank" rel="noopener noreferrer" className="bg-green-300 text-gray-900 px-6 py-3 rounded-full text-lg font-semibold hover:bg-green-400 transition duration-300 inline-flex items-center">
              View on GitHub
      ...
      <footer className="bg-gray-900 py-12">
        <div className="container mx-auto text-center">
          <div className="flex justify-center space-x-6 mb-8">
            <a href="https://github.com/bhosalevivek04" className="text-green-300 hover:text-green-400 text-2xl"><FontAwesomeIcon icon={faGithub} /></a>
            <a href="https://x.com/VivekBhosale04" className="text-green-300 hover:text-green-400 text-2xl"><FontAwesomeIcon icon={faXTwitter} /></a>
